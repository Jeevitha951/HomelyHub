  ...
  return (
    ...
    <div className='extra-info col-md-6 col-sm-12 col-12'>
        ...
        <p className='extra-description'>
            -Check-in time is 1pm & Check-out is 10am. 
            Early check-in or late check-out is permitted based on availability and prior initiation. 
            ...
            *Late check-out is permitted based on availability and a fee may be apllicable based on check-out time. 
